              ...
              <div className="col-lg-8 text-center">
                <div className="calculator-hero-content fade-in-up">
                  ...
                  <p className="lead mb-4">
                    Calculate your Capital Gains Tax with precision. Trusted by thousands of UK investors for accurate, HMRC-compliant calculations.
                  </p>
                  <div className="trust-indicators">
                    <div className="trust-indicator">
                      <i className="bi bi-shield-check trust-icon"></i>
              ...
              <div className="calculator-form-card p-4 p-md-5 mb-5">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="modern-form-field">
                    ...
                    <div className="modern-file-upload" onClick={() => document.getElementById('file-input')?.click()}>
                  ...
                  <div className="text-center mt-4">
                    ...
                    <div className="mt-3">
                      <small className="text-muted">
                        ...
                        Your data never leaves your browser - completely private & secure
                      </small>
                    </div>
                  </div>
                </form>
